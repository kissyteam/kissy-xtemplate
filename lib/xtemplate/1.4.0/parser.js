...
Lexer.prototype = {
    ...
    'getCurrentRules': function () {
        ...
        self.rules.forEach(function (r) {
            ...
            } else if (Array.inArray(currentState, state)) {
                rules.push(r);
            }
        });
        return rules;
    ...
    'lex': function () {
        ...
        console.error("lex error at line " + self.lineNumber + ":\n" + self.showDebugInfo());
        return undefined;
    }
};
Lexer.STATIC = {
...
parser.parse = function parse(input) {
    ...
    while (1) {
        ...
        if (!symbol) {
            console.log("it is not a valid input: " + input, "error");
            return false;
        }
        ...
        if (!action) {
            ...
            if (tableAction[state]) {
                tableAction[state].forEach(function (_, symbol) {
