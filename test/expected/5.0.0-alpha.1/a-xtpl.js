/** Compiled By KISSY-XTemplate 5.0.0-alpha.1 */
KISSY.add(function (S, require, exports, module) {
        ...
        var a = function (scope, buffer, undefined) {
            ...
            var exp22 = id20;
            if ((id20)) {
                var id21 = scope.resolve(["model", "isSelected"], 0);
                exp22 = id21;
            }
            params19.push(exp22);
            ...
            var params82 = [];
            var id83 = scope.resolve(["price", "now"], 0);
            var exp85 = id83;
            var id84 = scope.resolve(["price", "origin"], 0);
            exp85 = (id83) < (id84);
            params82.push(exp85);
            option81.params = params82;
            option81.fn = function (scope, buffer) {
                buffer.write('\n                <div class="price-line"><em class="price-original">', 0);
                var id86 = scope.resolve(["price", "origin_str"], 0);
            ...
            var id87 = scope.resolve(["price", "now_str"], 0);
            ...
            option88.fn = function (scope, buffer) {
                ...
                var exp95 = id93;
                if ((id93)) {
                    var id94 = scope.resolve(["promotions", "type"], 0);
                    exp95 = id94;
                }
                params92.push(exp95);
                ...
                option91.fn = function (scope, buffer) {
                    ...
                    var params97 = [];
                    var id98 = scope.resolve(["promotions", "hideTitle"], 0);
                    var exp99 = id98;
                    exp99 = (id98) === (false);
                    params97.push(exp99);
                    ...
                    option96.fn = function (scope, buffer) {
                        ...
                        var id100 = scope.resolve(["promotions", "type"], 0);
                        ...
                        var params102 = [];
                        var id103 = scope.resolve(["promotions", "endTime"], 0);
                        ...
                        buffer.write('">\n                        ', 0);
                        var id104 = scope.resolve(["promotions", "name"], 0);
            ...
            option105.fn = function (scope, buffer) {
                buffer.write('\n            ', 0);
                var id115 = scope.resolve(["amount", "now"], 0);
            ...
            option105.inverse = function (scope, buffer) {
                ...
                var exp121 = id118;
                if ((id118)) {
                    var id119 = scope.resolve(["amount", "max"], 0);
                    var exp120 = id119;
                    exp120 = (id119) <= (3);
                    exp121 = exp120;
                }
                ...
                option125.inverse = function (scope, buffer) {
                    buffer.write('\n            ', 0);
                    var id134 = scope.resolve(["amount", "now"], 0);
                ...
                option135.fn = function (scope, buffer) {
                    ...
                    var params139 = [];
                    var id140 = scope.resolve(["amount", "max"], 0);
                    var exp141 = id140;
                    exp141 = (id140) < (1);
                    ...
                    option138.inverse = function (scope, buffer) {
                        ...
                        var params143 = [];
                        var id144 = scope.resolve(["amount", "max"], 0);
                        var exp146 = id144;
                        var id145 = scope.resolve(["amount", "now"], 0);
                        exp146 = (id144) < (id145);
                        params143.push(exp146);
                        option142.params = params143;
                        option142.fn = function (scope, buffer) {
                            buffer.write('\n            <em class="error-msg">最多只能购买', 0);
                            var id147 = scope.resolve(["amount", "max"], 0);
                        ...
                        option142.inverse = function (scope, buffer) {
                            ...
                            var params149 = [];
                            var id150 = scope.resolve(["amount", "limit"], 0);
                            var exp152 = id150;
                            var id151 = scope.resolve(["amount", "max"], 0);
                            exp152 = (id150) <= (id151);
                            params149.push(exp152);
                            option148.params = params149;
                            option148.fn = function (scope, buffer) {
                                buffer.write('\n            <em class="s-danger-text">限购', 0);
                                var id153 = scope.resolve(["amount", "limit"], 0);
                            ...
                            option148.inverse = function (scope, buffer) {
                                ...
                                var params155 = [];
                                var id156 = scope.resolve(["amount", "max"], 0);
                                var exp157 = id156;
                                exp157 = (id156) <= (3);
                                ...
                                option154.fn = function (scope, buffer) {
                                    ...
                                    var id158 = scope.resolve(["amount", "max"], 0);
            ...
            var id166 = scope.resolve(["price", "sum_str"], 0);
            ...
            option169.fn = function (scope, buffer) {
                ...
                var exp177 = id174;
                if ((id174)) {
                    var id175 = scope.resolve(["model", "serviceCollapsed"], 0);
                    var exp176 = id175;
                    exp176 = (id175) !== (false);
                    exp177 = exp176;
                }
