/** Compiled By KISSY-XTemplate 5.0.0-alpha.3 */
/*jshint quotmark:false, loopfunc:true, indent:false, asi:true, unused:false, boss:true, sub:true*/
KISSY.add(function (S, require, exports, module) {
    var bXtplHtml = function (scope, buffer, undefined) {
    ...
    bXtplHtml.TPL_NAME = module.name;
    bXtplHtml.version = '5.0.0';
    module.exports = bXtplHtml;
});